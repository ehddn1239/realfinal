	...
	<div class="container" id="container">
		...
		<!-- 여기는 회원가입 페이지에용 -->
			<form action="account.reg.do" method="post">
				...
				<span>회원 가입을 시작하겠습니다!</span> 
				<input name="a_id" type="text" placeholder="UserID" /> 
				<input name="a_nickname" type="text" placeholder="사용하실 닉네임" />
				<input name="a_pw" type="password" placeholder="Password" />
				<input name="a_addr" type="text" placeholder="주소" />
				<input name="a_email" type="email" placeholder="이메일" />
				<input name="a_phone" type="tel" placeholder="전화번호" />
