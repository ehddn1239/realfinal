...
<div class="cate_"><span>Tee</span></div>
	<div class="content">
	...
	<div class="sellerbtn">
						<c:if test="${loginAccount.a_userType == 2}">
							<button onclick="deleteProduct('${t.p_no}','${t.p_category}')">삭제 /</button>
							<button
								onclick="location.href='product.update.go?p_no=${t.p_no}'">수정</button>
						</c:if>
					</div>
	</div>
	</c:forEach>
