...
<ul>
				<li><a href="allNewProduct.select?p_category=5">최신순</a></li>
				<li><a href="allLowProduct.select?p_category=5">낮은가격</a></li>
				<li><a href="allHighProduct.select?p_category=5">높은가격</a></li>
			</ul>
