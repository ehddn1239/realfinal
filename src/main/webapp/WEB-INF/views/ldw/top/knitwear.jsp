...
<div class="cate_"><span>Knit</span></div>
	<div class="content">
	...
	<div class="sellerbtn">
						<c:if test="${loginAccount.a_userType == 2}">
							<button onclick="deleteProduct('${k.p_no}','${k.p_category}')">삭제 /</button>
							<button
								onclick="location.href='product.update.go?p_no=${k.p_no}'">수정</button>
						</c:if>
					</div>
	</div>
	</c:forEach>
